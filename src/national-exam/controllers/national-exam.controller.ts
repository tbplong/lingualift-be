...
export class NationalExamController {
  ...
  public async getNationalExamsV2(
    ...
    const exams = await this.nationalExamService.getNationalExamsV2(getNationalExamsQueryV2Dto);
  ...
  public async updateNationalExam(
    ...
    await this.nationalExamService.updateNationalExam(examId, updateNationalExamRequestDto);
  }
}
