...
export class MockUserBuilder {
  ...
  public withLevel(level: string): MockUserBuilder {
    this.user.level = level;
    return this;
  }

  public withXp(xp: number): MockUserBuilder {
    this.user.xp = xp;
    return this;
  }

  public withRank(rank: number): MockUserBuilder {
    this.user.rank = rank;
    return this;
  }

  public withStreak(streak: number): MockUserBuilder {
