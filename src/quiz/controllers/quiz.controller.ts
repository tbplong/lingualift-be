...
import { CreateQuizResponseDto, QuizResponseDto, QuizsResponseDto, UpdateQuizDto } from '../dtos';
...
export class QuizController {
  ...
  public async create(@Body() quizDto: UpdateQuizDto): Promise<CreateQuizResponseDto> {
  ...
  @Get('/:id')
  // @BlockIfNotManager(true)
  public async readById(@Param('id') id: Types.ObjectId): Promise<QuizResponseDto> {
